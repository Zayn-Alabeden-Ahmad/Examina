# Generated by Django 5.1.3 on 2025-10-27 12:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('StarredCount', models.IntegerField(default=0)),
                ('Permissions', models.CharField(max_length=255)),
                ('StarTotalPoints', models.IntegerField(default=0)),
                ('Manager', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.teacher')),
                ('Person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
